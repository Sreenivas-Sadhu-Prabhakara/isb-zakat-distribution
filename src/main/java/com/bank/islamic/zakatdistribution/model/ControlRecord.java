package com.bank.islamic.zakatdistribution.model;
...
/**
 * The BIAN control record for this service domain: "Zakat Disbursement Distribution".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Distribute) applied
 * to its asset type (Zakat Disbursement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Zakat Disbursement Distribution";

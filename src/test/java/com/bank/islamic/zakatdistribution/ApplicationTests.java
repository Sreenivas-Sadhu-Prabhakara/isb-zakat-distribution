...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Zakat Distribution");
        assertThat(meta).containsEntry("functionalPattern", "Distribute");
    }

    @Test
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/zakat-disbursement-distribution/initiate",
